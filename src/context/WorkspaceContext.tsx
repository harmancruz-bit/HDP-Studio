...
export function WorkspaceProvider({ children }: { children: React.ReactNode }) {
  ...
  const value = useMemo<WorkspaceContextValue>(() => ({
    ...
    selectProduct: (product) => { setCurrentProduct(product); setCurrentModule(null); setCurrentScreen(null); setCurrentBlock(null) },
    selectModule: (module) => { setCurrentModule(module); setCurrentScreen(null); setCurrentBlock(null) },
